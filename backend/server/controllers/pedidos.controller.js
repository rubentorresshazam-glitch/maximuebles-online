...
exports.crearPedido = async (req, res) => {
  try {
    ...
    // ✅ GUARDAR PEDIDO → COLUMNAS Y VALORES COINCIDEN EXACTAMENTE
    const resultado = await db.query(
      `INSERT INTO pedidos 
       ...
       RETURNING id`,
      [
        nombre, correo, telefono, direccion, productosJson, total, notas || '',
    ...
    // ✅ SI PIDIÓ FACTURA → generarla y enviarla
